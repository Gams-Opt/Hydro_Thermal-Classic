...
St_p(t)         balance of p
Cal_o_f_ts(j)   per thermal plant 24 hours output
Obj_o_fs_ts     objs
;
...
Cal_p_hy_t_1(i,t)$(ord(t) eq 1).. p_hy_t(i,t)=e=par_hydro(i,'c1')*power(st_hydro(i,'vini'),2)+par_hydro(i,'c2')*power(q(i,t),2)+par_hydro(i,'c3')*st_hydro(i,'vini')*q(i,t)+par_hydro(i,'c4')*st_hydro(i,'vini')+par_hydro(i,'c5')*q(i,t);
Cal_p_hy_t(i,t)..   p_hy_t(i,t)=e=par_hydro(i,'c1')*power(v(i,t),2)+par_hydro(i,'c2')*power(q(i,t),2)+par_hydro(i,'c3')*v(i,t)*q(i,t)+par_hydro(i,'c4')*v(i,t)+par_hydro(i,'c5')*q(i,t)+par_hydro(i,'c6');
...
*Obj_p_f_t(j,t).. o_f_t(j,t)=e=par_ther(j,'d1')*power(p_f_t(j,t),2)+par_ther(j,'d2')*p_f_t(j,t)+par_ther(j,'d3');
Cal_o_f_ts(j)..  o_f_ts(j)=e=sum(pa_th,par_ther(j,pa_th)*power(p_f_ts(j),3-ord(pa_th)));
Obj_o_fs_ts..    o_fs_ts=e=sum(j,o_f_ts(j));

Cal_delay(i,t)$(ord(i) <3)..    in_delay(i,t)=e=0;
Cal_delay3(i,t)$(ord(i) = 3)..  in_delay(i,t)=e=(q('2',t-3)$(ord(t) >3)+q('1',t-2))$(ord(t) >2)+0$(ord(t) = 1);
Cal_delay4(i,t)$(ord(i) = 4)..  in_delay(i,t)=e=q('3',t-4)$(ord(t) >4)+0$(ord(t) <= 4);
St_P(t)..         load(t)=e=p_fs_t(t)+p_hys_t(t);
Cal_v_ini(i,t)$(ord(t) eq 1)..  v(i,t)=e=st_hydro(i,'vini')-q(i,t)+inflows(t,i)+in_delay(i,t);
Cal_v(i,t)$(ord(t) ne 1)..      v(i,t)=e=v(i,t-1)-q(i,t)+inflows(t,i)+in_delay(i,t);
model mincost /Cal_p_hy_t_1,Cal_p_hys_t,Cal_p_hys_ts,Cal_delay,Cal_delay3,Cal_delay4,Cal_v_ini,Cal_v,St_p,Cal_p_fs_t,Cal_P_f_ts,Cal_o_f_ts,Obj_o_fs_ts/;

solve mincost using nlp minimizing o_fs_ts;
display load,q.l,v.l,p_hy_t.l,p_hys_t.l,p_hys_ts.l,p_f_t.l,p_f_ts.l,p_fs_t.l,o_f_ts.l,o_fs_ts.l;
display in_delay.l;
